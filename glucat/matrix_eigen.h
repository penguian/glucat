...
namespace glucat
{
  namespace matrix
  {
    ...
    template <typename Scalar_T>
    class eigen_matrix_wrapper : public matrix_base<eigen_matrix_wrapper<Scalar_T>>
    {
    public:
    ...
    template <typename Scalar_T>
    class eigen_sparse_wrapper : public matrix_base<eigen_sparse_wrapper<Scalar_T>>
    {
    public:
