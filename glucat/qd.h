...
#define _GLUCAT_QD_F(_T, _F)                              \
  template <>                                             \
  inline auto numeric_traits<_T>::_F(const _T& val) -> _T \
  {                                                       \
    return ::_F(val);                                     \
  }
  ...
  template <>
  inline auto numeric_traits<dd_real>::isNaN(const dd_real& val) -> bool
  { return val.isnan(); }

  // Smart isinf for dd_real
  template <>
  inline auto numeric_traits<dd_real>::isInf(const dd_real& val) -> bool
  { return val.isinf(); }

  // Smart isnan or isinf for dd_real
  template <>
  inline auto numeric_traits<dd_real>::isNaN_or_isInf(const dd_real& val) -> bool
  { return val.isnan() || val.isinf(); }

  // to_int for dd_real
  template <>
  inline auto numeric_traits<dd_real>::to_int(const dd_real& val) -> int
  { return ::to_int(val); }

  // to_double for dd_real
  template <>
  inline auto numeric_traits<dd_real>::to_double(const dd_real& val) -> double
  { return ::to_double(val); }

  // to_scalar_t for dd_real
  template <>
  template <typename Other_Scalar_T>
  inline auto numeric_traits<dd_real>::to_scalar_t(const Other_Scalar_T& val) -> dd_real
  {
  ...
  template <>
  inline auto numeric_traits<dd_real>::fmod(const dd_real& lhs, const dd_real& rhs) -> dd_real
  { return ::fmod(lhs, rhs); }

  // pow for dd_real
  template <>
  inline auto numeric_traits<dd_real>::pow(const dd_real& val, int n) -> dd_real
  {
    if (val == dd_real(0))
    { return (n < 0) ? NaN() : (n == 0) ? dd_real(1) : dd_real(0); }
    auto result = dd_real(1);
    auto power = (n < 0) ? dd_real(1) / val : val;
    for (auto k = std::abs(n); k != 0; k /= 2)
    {
      if (k % 2)
        result *= power;
      power *= power;
  ...
  // Pi for dd_real
  template <>
  inline auto numeric_traits<dd_real>::pi() -> dd_real
  { return dd_real::_pi; }

  // log(2) for dd_real
  template <>
  inline auto numeric_traits<dd_real>::ln_2() -> dd_real
  ...
  template <>
  inline auto numeric_traits<qd_real>::isNaN(const qd_real& val) -> bool
  { return val.isnan(); }

  // Smart isinf for qd_real
  template <>
  inline auto numeric_traits<qd_real>::isInf(const qd_real& val) -> bool
  { return val.isinf(); }

  // Smart isnan or isinf for qd_real
  template <>
  inline auto numeric_traits<qd_real>::isNaN_or_isInf(const qd_real& val) -> bool
  { return val.isnan() || val.isinf(); }

  // to_int for qd_real
  template <>
  inline auto numeric_traits<qd_real>::to_int(const qd_real& val) -> int
  { return ::to_int(val); }

  // to_double for qd_real
  template <>
  inline auto numeric_traits<qd_real>::to_double(const qd_real& val) -> double
  { return ::to_double(val); }

  // to_scalar_t for qd_real
  template <>
  template <typename Other_Scalar_T>
  inline auto numeric_traits<qd_real>::to_scalar_t(const Other_Scalar_T& val) -> qd_real
  {
  ...
  template <>
  inline auto numeric_traits<qd_real>::fmod(const qd_real& lhs, const qd_real& rhs) -> qd_real
  { return ::fmod(lhs, rhs); }

  // pow for qd_real
  template <>
  inline auto numeric_traits<qd_real>::pow(const qd_real& val, int n) -> qd_real
  {
    if (val == qd_real(0))
    { return (n < 0) ? NaN() : (n == 0) ? qd_real(1) : qd_real(0); }
    auto result = qd_real(1);
    auto power = (n < 0) ? qd_real(1) / val : val;
    for (auto k = std::abs(n); k != 0; k /= 2)
    {
      if (k % 2)
        result *= power;
  ...
  // Pi for qd_real
  template <>
  inline auto numeric_traits<qd_real>::pi() -> qd_real
  { return qd_real::_pi; }

  // log(2) for qd_real
  template <>
  inline auto numeric_traits<qd_real>::ln_2() -> qd_real
...
namespace Eigen
{
  ...
  struct qd_real_eigen
  {
    ...
    qd_real_eigen& operator+=(const qd_real_eigen& other)
    {
      val += other.val;
      return *this;
    }
  ...
  struct dd_real_eigen
  {
    ...
    dd_real_eigen& operator+=(const dd_real_eigen& other)
    {
      val += other.val;
      return *this;
    }
  ...
  template <typename T>
  inline typename NumTraits<T>::Real abs(const T& x);
  template <typename T>
  inline typename NumTraits<T>::Real real(const T& x);
  template <typename T>
  inline typename NumTraits<T>::Real imag(const T& x);

  template <>
  inline qd_real_eigen abs(const ::qd_real& x)
  { return ::abs(x); }
  template <>
  inline dd_real_eigen abs(const ::dd_real& x)
  { return ::abs(x); }
  template <>
  inline qd_real_eigen real(const ::qd_real& x)
  { return x; }
  template <>
  inline dd_real_eigen real(const ::dd_real& x)
  { return x; }
  template <>
  inline qd_real_eigen imag(const ::qd_real&)
  { return 0.0; }
  template <>
  inline dd_real_eigen imag(const ::dd_real&)
  { return 0.0; }

  // Math functions for wrappers
  inline qd_real_eigen abs(const qd_real_eigen& x)
  { return ::abs(x.val); }
  inline dd_real_eigen abs(const dd_real_eigen& x)
  { return ::abs(x.val); }
  inline qd_real_eigen real(const qd_real_eigen& x)
  { return x.val; }
  inline dd_real_eigen real(const dd_real_eigen& x)
  { return x.val; }
  inline qd_real_eigen imag(const qd_real_eigen&)
  { return 0.0; }
  inline dd_real_eigen imag(const dd_real_eigen&)
  { return 0.0; }
}  // namespace Eigen
#endif
