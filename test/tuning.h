...
namespace glucat
{
  ...
  using tuning_values_slow_p =
      tuning_values<Tuning_Slow_Mult_Matrix_Threshold, Tuning_Default_CR_Sqrt_Max_Steps, Tuning_Default_DB_Sqrt_Max_Steps,
                    Tuning_Default_Log_Max_Outer_Steps, Tuning_Default_Log_Max_Inner_Steps, Tuning_Slow_Basis_Max_Count,
                    Tuning_Slow_Fast_Size_Threshold, Tuning_Slow_Inv_Fast_Dim_Threshold, Tuning_Default_Denom_Different_Bits,
                    Tuning_Default_Extra_Different_Bits, Tuning_Default_Products_Different_Bits,
                    Tuning_Default_Products_Matrix_Threshold>;
  ...
  using tuning_values_naive_p =
      tuning_values<Tuning_Naive_Mult_Matrix_Threshold, Tuning_Default_CR_Sqrt_Max_Steps, Tuning_Default_DB_Sqrt_Max_Steps,
                    Tuning_Default_Log_Max_Outer_Steps, Tuning_Default_Log_Max_Inner_Steps, Tuning_Naive_Basis_Max_Count,
                    Tuning_Naive_Fast_Size_Threshold, Tuning_Naive_Inv_Fast_Dim_Threshold, Tuning_Default_Denom_Different_Bits,
                    Tuning_Default_Extra_Different_Bits, Tuning_Default_Products_Different_Bits,
                    Tuning_Default_Products_Matrix_Threshold>;
  ...
  using tuning_values_fast_p =
      tuning_values<Tuning_Fast_Mult_Matrix_Threshold, Tuning_Fast_CR_Sqrt_Max_Steps, Tuning_Fast_DB_Sqrt_Max_Steps,
                    Tuning_Fast_Log_Max_Outer_Steps, Tuning_Fast_Log_Max_Inner_Steps, Tuning_Fast_Basis_Max_Count,
                    Tuning_Fast_Fast_Size_Threshold, Tuning_Fast_Inv_Fast_Dim_Threshold, Tuning_Default_Denom_Different_Bits,
                    Tuning_Default_Extra_Different_Bits, Tuning_Default_Products_Different_Bits,
                    Tuning_Default_Products_Matrix_Threshold>;
