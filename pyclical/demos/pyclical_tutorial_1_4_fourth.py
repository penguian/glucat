...
def run(ctx):
    ...
    print_line()
    print_fill(
        "Example 15.1. Calculate the length of the vector a == 2{1}+2{2}+4{3}+5{4}."
    )
    print_line()
    ...
    print_line()
    print_fill(
        "Example 15.2. Determine the area of the parallelogram with sides"
    ...
    print_line()
    print_fill(
        "Example 15.3. Determine the volume of the parallelepiped with sides"
    ...
    pause()
    check_exec(
        "set V to be the oriented volume of the parallelepiped with sides a, b and c.",
        "V",
        "a ^ b ^ c",
    )
    check_exec(
    ...
    print_line()
    print_fill(
        "Compare with Example 12.3 from Tutorial 1.2 Space geometry and vector algebra."
    )
    print_line()
    ...
    print_line()
    print_fill(
        " In this example we have used the alternate notation for vectors."
    )
    print_line()
    ...
    pause()
    check_exec(
        "set b to be the multivector (1 + {1,2} + {3,4} - {1,2,3,4})/2.",
        "b",
        "a - e({1,2,3,4})",
    )
    check_exec("set b2 to be the square of b.", "b2", "b * b")

    pause()
    print_line()
    print_fill(
        "You have completed the tutorial file pyclical_tutorial_1_4_fourth.py."
    )
