...
namespace glucat
{
  namespace matrix
  {
    ...
    inline bool solve(eigen_matrix_wrapper<Scalar_T>& X, const eigen_matrix_wrapper<Scalar_T>& lhs,
                      const eigen_matrix_wrapper<Scalar_T>& rhs, int opts = 0)
    {
      // Solve lhs*X = rhs
     ...
     */
    template <typename Scalar_T>
    inline eigen_matrix_wrapper<Scalar_T>::eigen_matrix_wrapper(matrix_index_t rows, matrix_index_t cols)
    {
      set_size(rows, cols);
      m_mat.setZero();
    }
    ...
    inline eigen_matrix_wrapper<Scalar_T>::eigen_matrix_wrapper(const Eigen::MatrixBase<Derived_T>& other)
    {
      m_mat = other;
    }
    ...
    inline eigen_matrix_wrapper<Scalar_T>::eigen_matrix_wrapper(const Other_Matrix_T& other)
    {
     ...
     */
    template <typename Scalar_T>
    inline eigen_matrix_wrapper<Scalar_T>& eigen_matrix_wrapper<Scalar_T>::operator=(const eigen_matrix_wrapper<Scalar_T>& other)
    {
      if (this != &other)
        m_mat = other.m_mat;
      return *this;
     ...
     */
    template <typename Scalar_T>
    inline eigen_matrix_wrapper<Scalar_T>& eigen_matrix_wrapper<Scalar_T>::operator=(
        eigen_matrix_wrapper<Scalar_T>&& other) noexcept(std::is_nothrow_move_assignable_v<Scalar_T>)
    {
      if (this != &other)
        m_mat = std::move(other.m_mat);
      return *this;
    ...
    inline eigen_matrix_wrapper<Scalar_T>::eigen_matrix_wrapper(const eigen_sparse_wrapper<Other_Scalar_T>& other)
    {
      set_size(other.nbr_rows(), other.nbr_cols());
      m_mat.setZero();
    ...
    template <typename Scalar_T>
    template <typename Other_Matrix_T>
    inline eigen_matrix_wrapper<Scalar_T>& eigen_matrix_wrapper<Scalar_T>::operator=(const Other_Matrix_T& other)
    {
      if constexpr (requires { other.nbr_rows(); })
      {
        set_size(other.nbr_rows(), other.nbr_cols());
     ...
     */
    template <typename Scalar_T>
    inline void eigen_matrix_wrapper<Scalar_T>::set_size(matrix_index_t rows, matrix_index_t cols)
    {
     ...
     */
    template <typename Scalar_T>
    inline matrix_index_t eigen_matrix_wrapper<Scalar_T>::nbr_rows() const
     ...
     */
    template <typename Scalar_T>
    inline matrix_index_t eigen_matrix_wrapper<Scalar_T>::nbr_cols() const
     ...
     */
    template <typename Scalar_T>
    inline void eigen_matrix_wrapper<Scalar_T>::clear()
    {
      m_mat.setZero();
    }
     ...
     */
    template <typename Scalar_T>
    inline void eigen_matrix_wrapper<Scalar_T>::zeros()
    {
      m_mat.setZero();
    }
     ...
     */
    template <typename Scalar_T>
    inline void eigen_matrix_wrapper<Scalar_T>::zeros(matrix_index_t rows, matrix_index_t cols)
    {
      set_size(rows, cols);
      zeros();
    }
     ...
     */
    template <typename Scalar_T>
    inline void eigen_matrix_wrapper<Scalar_T>::unit(matrix_index_t rows, matrix_index_t cols)
    {
      set_size(rows, cols);
      m_mat.setIdentity();
    }
     ...
     */
    template <typename Scalar_T>
    inline bool eigen_matrix_wrapper<Scalar_T>::is_finite() const
     ...
     */
    template <typename Scalar_T>
    inline bool eigen_matrix_wrapper<Scalar_T>::has_nan() const
    { return m_mat.hasNaN(); }
     ...
     */
    template <typename Scalar_T>
    inline Scalar_T& eigen_matrix_wrapper<Scalar_T>::operator()(matrix_index_t i, matrix_index_t j)
    { return m_mat(i, j); }
     ...
     */
    template <typename Scalar_T>
    inline const Scalar_T& eigen_matrix_wrapper<Scalar_T>::operator()(matrix_index_t i, matrix_index_t j) const
    { return m_mat(i, j); }
     ...
     */
    template <typename Scalar_T>
    inline eigen_matrix_wrapper<Scalar_T>& eigen_matrix_wrapper<Scalar_T>::operator*=(const Scalar_T& val)
    {
      m_mat *= val;
      return *this;
    }
    ...
    template <typename Scalar_T>
    inline eigen_matrix_wrapper<Scalar_T> eigen_matrix_wrapper<Scalar_T>::operator+(
        const eigen_matrix_wrapper<Scalar_T>& other) const
     ...
     */
    template <typename Scalar_T>
    inline eigen_matrix_wrapper<Scalar_T> eigen_matrix_wrapper<Scalar_T>::operator-() const
     ...
     */
    template <typename Scalar_T>
    inline eigen_matrix_wrapper<Scalar_T> eigen_matrix_wrapper<Scalar_T>::t() const
     ...
     */
    template <typename Scalar_T>
    inline std::ostream& operator<<(std::ostream& os, const eigen_matrix_wrapper<Scalar_T>& m)
    { return os << m.m_mat; }
     ...
     */
    template <typename Scalar_T>
    inline Scalar_T eigen_matrix_wrapper<Scalar_T>::trace() const
    { return m_mat.trace(); }
     ...
     */
    template <typename Scalar_T>
    inline std::vector<std::complex<double>> eigen_matrix_wrapper<Scalar_T>::eigenvalues() const
    {
      // Optimized for real matrices as per matrix representation
      if constexpr (std::is_arithmetic_v<Scalar_T> || std::is_same_v<Scalar_T, double> || std::is_same_v<Scalar_T, float>
                    || std::is_same_v<Scalar_T, long double>)
      {
    ...
    template <typename Scalar_T>
    inline bool eigen_matrix_wrapper<Scalar_T>::operator==(const eigen_matrix_wrapper& other) const
     ...
     */
    template <typename Scalar_T>
    inline Scalar_T eigen_matrix_wrapper<Scalar_T>::norm_inf() const
     ...
     */
    template <typename Scalar_T>
    inline Scalar_T eigen_matrix_wrapper<Scalar_T>::norm_frob2() const
     ...
     */
    template <typename Scalar_T>
    inline bool eigen_matrix_wrapper<Scalar_T>::isnan() const
    { return m_mat.hasNaN(); }
     ...
     */
    template <typename Scalar_T>
    inline bool eigen_matrix_wrapper<Scalar_T>::isinf() const
     ...
     */
    template <typename Scalar_T>
    inline matrix_index_t eigen_matrix_wrapper<Scalar_T>::nnz() const
    { return (m_mat.array() != 0).count(); }

    template <typename Scalar_T>
    inline bool eigen_matrix_wrapper<Scalar_T>::is_zero() const
    ...
    inline Result_Scalar_T eigen_matrix_wrapper<Scalar_T>::inner(const Other& other) const
    {
    ...
    inline Scalar_T eigen_matrix_wrapper<Scalar_T>::trace_product(const Other& other) const
    {
    ...
    template <typename Scalar_T>
    inline void eigen_matrix_wrapper<Scalar_T>::involute()
    {
    ...
    template <typename Scalar_T>
    inline void eigen_matrix_wrapper<Scalar_T>::reverse(index_t p, index_t q)
    {
    ...
    template <typename Scalar_T>
    inline void eigen_matrix_wrapper<Scalar_T>::similarity_transform(const std::vector<matrix_index_t>& perm,
    ...
    template <typename Scalar_T>
    inline void eigen_matrix_wrapper<Scalar_T>::transpose_similarity_transform(const std::vector<matrix_index_t>& perm,
                                                                               const std::vector<Scalar_T>& signs)
    {
      const matrix_index_t n = m_mat.rows();
      std::vector<matrix_index_t> inv_perm(n);
     ...
     */
    template <typename Scalar_T>
    inline eigen_matrix_wrapper<Scalar_T> eigen_matrix_wrapper<Scalar_T>::kron(const eigen_matrix_wrapper<Scalar_T>& other) const
    {
    ...
    template <typename Scalar_T>
    inline eigen_matrix_wrapper<Scalar_T> eigen_matrix_wrapper<Scalar_T>::mono_kron(
        const eigen_matrix_wrapper<Scalar_T>& other) const
    { return kron(other); }

    template <typename Scalar_T>
    inline eigen_matrix_wrapper<Scalar_T> eigen_matrix_wrapper<Scalar_T>::mono_prod(
        const eigen_matrix_wrapper<Scalar_T>& other) const
    { return eigen_matrix_wrapper<Scalar_T>(MatrixType(m_mat * other.m_mat)); }
    ...
    template <typename Scalar_T>
    template <typename Other_Scalar_T>
    inline eigen_matrix_wrapper<Other_Scalar_T> eigen_matrix_wrapper<Scalar_T>::kron(
        const eigen_sparse_wrapper<Other_Scalar_T>& other) const
    {
      if (nbr_rows() == 2 && nbr_cols() == 2)
      {
    ...
    inline RHS_T eigen_matrix_wrapper<Scalar_T>::nork(const RHS_T& rhs, bool mono) const
    {
      ...
      for (matrix_index_t r = 0; r < nbr_rows(); ++r)
      {
        for (matrix_index_t c = 0; c < nbr_cols(); ++c)
        {
          ...
          if (val != Scalar_T(0))
          {
            ...
            {
              result.m_mat +=
                  static_cast<typename RHS_T::value_type>(val) * rhs.m_mat.block(start_row, start_col, blk_rows, blk_cols);
            }
            else
            {
              for (matrix_index_t i = 0; i < blk_rows; ++i)
                for (matrix_index_t j = 0; j < blk_cols; ++j)
                  result(i, j) += static_cast<typename RHS_T::value_type>(val)
                                  * static_cast<typename RHS_T::value_type>(rhs(start_row + i, start_col + j));
            }
          }
        }
      }
     ...
     */
    template <typename Scalar_T>
    inline matrix_index_t eigen_sparse_wrapper<Scalar_T>::nbr_rows() const
    { return static_cast<matrix_index_t>(m_mat.rows()); }
     ...
     */
    template <typename Scalar_T>
    inline matrix_index_t eigen_sparse_wrapper<Scalar_T>::nbr_cols() const
    { return static_cast<matrix_index_t>(m_mat.cols()); }
     ...
     */
    template <typename Scalar_T>
    inline eigen_sparse_wrapper<Scalar_T>::eigen_sparse_wrapper(matrix_index_t rows, matrix_index_t cols,
                                                                matrix_index_t estimated_nnz)
    {
      set_size(rows, cols);
      if (estimated_nnz > 0)
        m_mat.reserve(estimated_nnz);
    }
     ...
     */
    template <typename Scalar_T>
    inline eigen_sparse_wrapper<Scalar_T>& eigen_sparse_wrapper<Scalar_T>::operator=(const eigen_sparse_wrapper<Scalar_T>& other)
    {
      if (this != &other)
        m_mat = other.m_mat;
      return *this;
     ...
     */
    template <typename Scalar_T>
    inline eigen_sparse_wrapper<Scalar_T>& eigen_sparse_wrapper<Scalar_T>::operator=(
        eigen_sparse_wrapper<Scalar_T>&& other) noexcept(std::is_nothrow_move_assignable_v<Scalar_T>)
    {
      if (this != &other)
        m_mat = std::move(other.m_mat);
      return *this;
     ...
     */
    template <typename Scalar_T>
    inline void eigen_sparse_wrapper<Scalar_T>::set_size(matrix_index_t rows, matrix_index_t cols)
    {
      m_mat.resize(rows, cols);
    }
     ...
     */
    template <typename Scalar_T>
    inline void eigen_sparse_wrapper<Scalar_T>::clear()
    {
      m_mat.setZero();
    }
     ...
     */
    template <typename Scalar_T>
    inline void eigen_sparse_wrapper<Scalar_T>::zeros()
    {
      m_mat.setZero();
    }
     ...
     */
    template <typename Scalar_T>
    inline void eigen_sparse_wrapper<Scalar_T>::zeros(matrix_index_t rows, matrix_index_t cols)
    {
      set_size(rows, cols);
      zeros();
    }
     ...
     */
    template <typename Scalar_T>
    inline void eigen_sparse_wrapper<Scalar_T>::unit(matrix_index_t rows, matrix_index_t cols)
    {
      set_size(rows, cols);
      m_mat.setIdentity();
    }
     ...
     */
    template <typename Scalar_T>
    inline typename eigen_sparse_wrapper<Scalar_T>::const_iterator eigen_sparse_wrapper<Scalar_T>::begin() const
     ...
     */
    template <typename Scalar_T>
    inline typename eigen_sparse_wrapper<Scalar_T>::const_iterator eigen_sparse_wrapper<Scalar_T>::end() const
     ...
     */
    template <typename Scalar_T>
    inline Scalar_T eigen_sparse_wrapper<Scalar_T>::operator()(matrix_index_t i, matrix_index_t j) const
     ...
     */
    template <typename Scalar_T>
    inline Scalar_T& eigen_sparse_wrapper<Scalar_T>::operator()(matrix_index_t i, matrix_index_t j)
    ...
    template <typename Scalar_T>
    inline eigen_sparse_wrapper<Scalar_T> eigen_sparse_wrapper<Scalar_T>::operator*(
        const eigen_sparse_wrapper<Scalar_T>& other) const
     ...
     */
    template <typename Scalar_T>
    inline eigen_sparse_wrapper<Scalar_T>& eigen_sparse_wrapper<Scalar_T>::operator*=(const Scalar_T& val)
    {
      m_mat *= val;
      return *this;
    }
     ...
     */
    template <typename Scalar_T>
    inline std::ostream& operator<<(std::ostream& os, const eigen_sparse_wrapper<Scalar_T>& m)
    { return os << m.m_mat; }
     ...
     */
    template <typename Scalar_T>
    inline eigen_sparse_wrapper<Scalar_T>::const_iterator::const_iterator(const MatrixType* mat, bool start)
        : mp_mat(mat)
        , m_outer(0)
        , m_inner(*mat, 0)
    {
     ...
     */
    template <typename Scalar_T>
    inline void eigen_sparse_wrapper<Scalar_T>::const_iterator::advance()
    {
      if (m_inner)
        ++m_inner;
     ...
     */
    template <typename Scalar_T>
    inline bool eigen_sparse_wrapper<Scalar_T>::const_iterator::is_end() const
     ...
     */
    template <typename Scalar_T>
    inline typename eigen_sparse_wrapper<Scalar_T>::const_iterator& eigen_sparse_wrapper<Scalar_T>::const_iterator::operator++()
    {
      advance();
      return *this;
    }
     ...
     */
    template <typename Scalar_T>
    inline bool eigen_sparse_wrapper<Scalar_T>::const_iterator::operator!=(const const_iterator& other) const
    {
     ...
     */
    template <typename Scalar_T>
    inline matrix_index_t eigen_sparse_wrapper<Scalar_T>::const_iterator::row() const
    { return m_inner.row(); }
     ...
     */
    template <typename Scalar_T>
    inline matrix_index_t eigen_sparse_wrapper<Scalar_T>::const_iterator::col() const
    { return m_inner.col(); }
     ...
     */
    template <typename Scalar_T>
    inline Scalar_T eigen_sparse_wrapper<Scalar_T>::const_iterator::operator*() const
     ...
     */
    template <typename Scalar_T>
    inline bool eigen_sparse_wrapper<Scalar_T>::isinf() const
    {
     ...
     */
    template <typename Scalar_T>
    inline bool eigen_sparse_wrapper<Scalar_T>::isnan() const
    {
      for (matrix_index_t k = 0; k < static_cast<matrix_index_t>(m_mat.outerSize()); ++k)
        for (typename MatrixType::InnerIterator it(m_mat, k); it; ++it)
     ...
     */
    template <typename Scalar_T>
    inline Scalar_T eigen_sparse_wrapper<Scalar_T>::trace() const
    ...
    template <typename Scalar_T>
    template <typename Other_Scalar_T>
    inline eigen_matrix_wrapper<Other_Scalar_T> eigen_sparse_wrapper<Scalar_T>::kron(
        const eigen_matrix_wrapper<Other_Scalar_T>& other) const
    {
      eigen_matrix_wrapper<Other_Scalar_T> result(nbr_rows() * other.nbr_rows(), nbr_cols() * other.nbr_cols());
      result.zeros();
     ...
     */
    template <typename Scalar_T>
    inline eigen_sparse_wrapper<Scalar_T> eigen_sparse_wrapper<Scalar_T>::kron(const eigen_sparse_wrapper<Scalar_T>& other) const
    {
     ...
     */
    template <typename Scalar_T>
    inline eigen_sparse_wrapper<Scalar_T> eigen_sparse_wrapper<Scalar_T>::mono_kron(
        const eigen_sparse_wrapper<Scalar_T>& other) const
    {
      eigen_sparse_wrapper<Scalar_T> result(nbr_rows() * other.nbr_rows(), nbr_cols() * other.nbr_cols());
      std::vector<Eigen::Triplet<Scalar_T>> triplets;
     ...
     */
    template <typename Scalar_T>
    inline eigen_sparse_wrapper<Scalar_T> eigen_sparse_wrapper<Scalar_T>::mono_prod(
        const eigen_sparse_wrapper<Scalar_T>& other) const
    {
     ...
     */
    template <typename Scalar_T>
    inline Scalar_T eigen_sparse_wrapper<Scalar_T>::norm_inf() const
    {
     ...
     */
    template <typename Scalar_T>
    inline Scalar_T eigen_sparse_wrapper<Scalar_T>::norm_frob2() const
    { return static_cast<Scalar_T>(m_mat.squaredNorm()); }
     ...
     */
    template <typename Scalar_T>
    inline matrix_index_t eigen_sparse_wrapper<Scalar_T>::nnz() const
    { return m_mat.nonZeros(); }

    template <typename Scalar_T>
    inline bool eigen_sparse_wrapper<Scalar_T>::is_zero() const
    {
      for (int k = 0; k < m_mat.outerSize(); ++k)
        for (typename MatrixType::InnerIterator it(m_mat, k); it; ++it)
          if (it.value() != Scalar_T(0))
            return false;
      return true;
    }

    template <typename Scalar_T>
    inline bool eigen_sparse_wrapper<Scalar_T>::operator==(const eigen_sparse_wrapper& other) const
    {
      // Sparse comparison: ensure we don't return false due to stored zeros
      if (m_mat.rows() != other.m_mat.rows() || m_mat.cols() != other.m_mat.cols())
        return false;
    ...
    template <typename Scalar_T>
    template <typename Result_Scalar_T, typename Other>
    inline Result_Scalar_T eigen_sparse_wrapper<Scalar_T>::inner(const Other& other) const
    {
      Result_Scalar_T sum = Result_Scalar_T(0);
      for (matrix_index_t k = 0; k < static_cast<matrix_index_t>(m_mat.outerSize()); ++k)
        for (typename MatrixType::InnerIterator it(m_mat, k); it; ++it)
    ...
    template <typename Scalar_T>
    template <typename Other>
    inline Scalar_T eigen_sparse_wrapper<Scalar_T>::trace_product(const Other& other) const
    {
      using traits_t = numeric_traits<Scalar_T>;
      const auto dim = matrix_index_t(m_mat.rows());
      if (dim == 0)
    ...
    template <typename Scalar_T>
    inline void eigen_sparse_wrapper<Scalar_T>::involute()
    {
      for (int k = 0; k < m_mat.outerSize(); ++k)
        for (typename MatrixType::InnerIterator it(m_mat, k); it; ++it)
    ...
    template <typename Scalar_T>
    inline void eigen_sparse_wrapper<Scalar_T>::reverse(index_t p, index_t q)
    {
      if (q == 0)
      {
    ...
    template <typename Scalar_T>
    inline void eigen_sparse_wrapper<Scalar_T>::similarity_transform(const std::vector<matrix_index_t>& perm,
                                                                     const std::vector<Scalar_T>& signs)
    {
      const matrix_index_t n = m_mat.rows();
      std::vector<matrix_index_t> inv_perm(n);
    ...
    template <typename Scalar_T>
    inline void eigen_sparse_wrapper<Scalar_T>::transpose_similarity_transform(const std::vector<matrix_index_t>& perm,
                                                                               const std::vector<Scalar_T>& signs)
    {
      const matrix_index_t n = m_mat.rows();
      std::vector<matrix_index_t> inv_perm(n);
    ...
    template <typename Scalar_T>
    template <typename RHS_T>
    inline RHS_T eigen_sparse_wrapper<Scalar_T>::nork(const RHS_T& rhs, bool mono) const
    {
     ...
     */
    template <typename Scalar_T>
    inline std::vector<std::complex<double>> eigen_sparse_wrapper<Scalar_T>::eigenvalues() const
    {
      throw std::runtime_error("Not implemented for sparse");
    }  // Usually not computed directly on sparse
     ...
     */
    template <typename Scalar_T>
    inline eigen_sparse_wrapper<Scalar_T> operator*(const eigen_sparse_wrapper<Scalar_T>& m, Scalar_T s)
    {
     ...
     */
    template <typename Scalar_T>
    inline eigen_sparse_wrapper<Scalar_T> operator*(Scalar_T s, const eigen_sparse_wrapper<Scalar_T>& m)
    { return m * s; }
     ...
     */
    template <typename Scalar_T>
    inline eigen_sparse_wrapper<Scalar_T> operator+(const eigen_sparse_wrapper<Scalar_T>& lhs,
                                                    const eigen_sparse_wrapper<Scalar_T>& rhs)
    {
...
TEST_CASE("matrix::eigen_wrappers")
{
  SUBCASE("float")
  {
    glucat::matrix::test_eigen_wrappers_templated<float>();
  }
  SUBCASE("double")
  {
    glucat::matrix::test_eigen_wrappers_templated<double>();
  }
  SUBCASE("long double")
  {
    glucat::matrix::test_eigen_wrappers_templated<long double>();
  }
#ifdef _GLUCAT_USE_QD
  SUBCASE("dd_real")
  {
    glucat::matrix::test_eigen_wrappers_templated<dd_real>();
  }
  SUBCASE("qd_real")
  {
    glucat::matrix::test_eigen_wrappers_templated<qd_real>();
  }
#endif
}
#endif
...
namespace Eigen
{
  namespace internal
  {
    ...
    {
      static inline qd_real run(const long& x) { return qd_real(static_cast<double>(x)); }
    };

    template <>
    struct cast_impl<unsigned long, qd_real>
    {
      static inline qd_real run(const unsigned long& x) { return qd_real(static_cast<double>(x)); }
    };
    ...
    {
      static inline dd_real run(const long& x) { return dd_real(static_cast<double>(x)); }
    };

    template <>
    struct cast_impl<unsigned long, dd_real>
    {
      static inline dd_real run(const unsigned long& x) { return dd_real(static_cast<double>(x)); }
    };
