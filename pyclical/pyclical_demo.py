...
print "      -Electromagnetism in the Clifford algebras  R_3  and  R_(3,1)"
print "      -Complex Clifford algebra  CxR_(3,1)"
...
print ""
print "    Check that the Lorentz invariants are preserved (j == -{-1,1,2,3})"
print ""
...
print "    COMPLEX CLIFFORD ALGEBRA  CxR_(3,1)"
print ""
print "    The role of the imaginary unit is played by a unit bivector of  R_(3,3)"
print ""
...
print "    CAYLEY ALGEBRA OF OCTONIONS"
print ""
print "    Define a Cayley product of two paravectors in  R+R^(0,7)"
print ""
...
pause()
print ""
print "    Consider the associator of three vectors in  R^(0,7)"
print ""
...
pause()
print ""
print "    Check the Moufang identity (a o b) o (c o a) == (a o (b o c)) o a"
print ""
...
print ""
print "    We choose the two extra dimensions  e(-2), e(4)  so that our Minkowski space-time"
print "    has a basis  { e(-1), e(1), e(2), e(3) }"
print ""
...
pause()
print ""
print "    Here are the entries of the vahlen matrix"
print ""
...
pause()
print ""
print "    Rotate  x  by the angle  pi/2  and perform a boost in the direction  e(3)"
print ""
...
print ""
print "    Here  v == e({1,2,3})*f  as the following computation shows:"
print ""
...
print "    -{-4,1}+{-3,2}, -{-3,2}+{-2,3},"
print "    -{-3,1}+{1,2}, -{-3,1}-{-4,2}, {-4,-1}-{-1,1},"
print "    -{-2,1}+{1,3}, -{-2,1}-{-4,3}, {-3,-1}-{-1,2},"
print "    -{-2,2}+{2,3}, -{-2,2}-{-3,3}, {-2,-1}-{-1,3},"
