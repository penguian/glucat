...
namespace glucat
{
  ...
  public:
    ...
    virtual auto operator-=(const Scalar_T& scr) -> multivector_t& = 0;
    // Unary -
    virtual auto operator-() const -> multivector_t = 0;
    ...
    virtual auto inv() const -> multivector_t = 0;
    // *this to the m
    virtual auto pow(int m) const -> multivector_t = 0;
    // Outer product power
    virtual auto outer_pow(int m) const -> multivector_t = 0;
    // Subalgebra generated by all generators of terms of given multivector
    virtual auto frame() const -> index_set_t = 0;
    ...
    virtual auto operator()(index_t grade) const -> multivector_t = 0;
    // Scalar part
    virtual auto scalar() const -> Scalar_T = 0;
    // Pure part
    virtual auto pure() const -> multivector_t = 0;
    // Even part of multivector, sum of even grade terms
    virtual auto even() const -> multivector_t = 0;
    // Odd part of multivector, sum of odd grade terms
    virtual auto odd() const -> multivector_t = 0;
    // Vector part of multivector, as a vector_t with respect to frame()
    virtual auto vector_part() const -> vector_t = 0;
    // Vector part of multivector, as a vector_t with respect to frm
    virtual auto vector_part(const index_set_t frm, const bool prechecked) const -> vector_t = 0;
    // Main involution, each {i} is replaced by -{i} in each term, eg. {1} -> -{1}
    virtual auto involute() const -> multivector_t = 0;
    // Reversion, eg. {1}*{2} -> {2}*{1}
    virtual auto reverse() const -> multivector_t = 0;
    // Conjugation, reverse o involute == involute o reverse
    virtual auto conj() const -> multivector_t = 0;
...
#define _GLUCAT_CLIFFORD_ALGEBRA_OPERATIONS                                                                  \
  ...
  auto vector_part(const index_set_t frm, const bool prechecked = false) const -> vector_t override;         \
  ...
  auto versor(const multivector_t& R, const bool prechecked = false) const -> multivector_t override;        \
  auto versor_exp(const multivector_t& A, const bool prechecked = false) const -> multivector_t override;    \
  auto truncated(const Scalar_T& limit = multivector_t::default_truncation) const -> multivector_t override; \
...
#define _GLUCAT_CLIFFORD_ALGEBRA_ASSIGNMENT_OPERATIONS_IMP(CLASS)                                                            \
  ...
  template <template <typename, const index_t, const index_t, typename> class Other_Multivector>                             \
  auto CLASS<Scalar_T, LO, HI, Tune_P>::operator=(const Other_Multivector<Scalar_T, LO, HI, Tune_P>& rhs) -> multivector_t&  \
  {                                                                                                                          \
    return *this = multivector_t(rhs);                                                                                       \
  }                                                                                                                          \
  template <typename Scalar_T, const index_t LO, const index_t HI, typename Tune_P>                                          \
  template <template <typename, const index_t, const index_t, typename> class Other_Multivector>                             \
  auto CLASS<Scalar_T, LO, HI, Tune_P>::operator+=(const Other_Multivector<Scalar_T, LO, HI, Tune_P>& rhs) -> multivector_t& \
  ...
  template <template <typename, const index_t, const index_t, typename> class Multivector,
            template <typename, const index_t, const index_t, typename> class RHS, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto error_squared(const Multivector<Scalar_T, LO, HI, Tune_P>& lhs, const RHS<Scalar_T, LO, HI, Tune_P>& rhs,
  ...
  template <template <typename, const index_t, const index_t, typename> class Multivector,
            template <typename, const index_t, const index_t, typename> class RHS, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto approx_equal(const Multivector<Scalar_T, LO, HI, Tune_P>& lhs, const RHS<Scalar_T, LO, HI, Tune_P>& rhs,
  ...
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto operator+(const Multivector<Scalar_T, LO, HI, Tune_P>& lhs, const Scalar_T& scr) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Geometric sum of scalar and multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto operator+(const Scalar_T& scr, const Multivector<Scalar_T, LO, HI, Tune_P>& rhs) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Geometric sum
  template <template <typename, const index_t, const index_t, typename> class Multivector,
            template <typename, const index_t, const index_t, typename> class RHS, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto operator+(const Multivector<Scalar_T, LO, HI, Tune_P>& lhs, const RHS<Scalar_T, LO, HI, Tune_P>& rhs)
  ...
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto inv(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;
  ...
  template <template <typename, const index_t, const index_t, typename> class Multivector,
            template <typename, const index_t, const index_t, typename> class RHS, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto pow(const Multivector<Scalar_T, LO, HI, Tune_P>& lhs, const RHS<Scalar_T, LO, HI, Tune_P>& rhs)
      -> Multivector<Scalar_T, LO, HI, Tune_P>;
  ...
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto pure(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Even part
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto even(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Odd part
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto odd(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Vector part of multivector, as a vector_t with respect to frame()
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto vector_part(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> std::vector<Scalar_T>;

  // Main involution, each {i} is replaced by -{i} in each term, eg. {1}*{2} -> (-{2})*(-{1})
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto involute(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Reversion, eg. {1}*{2} -> {2}*{1}
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto reverse(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Conjugation, rev o invo == invo o rev
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto conj(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;
  ...
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto sqrt(const Multivector<Scalar_T, LO, HI, Tune_P>& val, const Multivector<Scalar_T, LO, HI, Tune_P>& i,
            const bool prechecked = false) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Square root of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto sqrt(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;
  ...
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto log(const Multivector<Scalar_T, LO, HI, Tune_P>& val, const Multivector<Scalar_T, LO, HI, Tune_P>& i,
           const bool prechecked = false) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Natural logarithm of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto log(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Cosine of multivector with specified complexifier
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto cos(const Multivector<Scalar_T, LO, HI, Tune_P>& val, const Multivector<Scalar_T, LO, HI, Tune_P>& i,
           const bool prechecked = false) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Cosine of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto cos(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Inverse cosine of multivector with specified complexifier
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto acos(const Multivector<Scalar_T, LO, HI, Tune_P>& val, const Multivector<Scalar_T, LO, HI, Tune_P>& i,
            const bool prechecked = false) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Inverse cosine of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto acos(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Hyperbolic cosine of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto cosh(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Inverse hyperbolic cosine of multivector with specified complexifier
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto acosh(const Multivector<Scalar_T, LO, HI, Tune_P>& val, const Multivector<Scalar_T, LO, HI, Tune_P>& i,
             const bool prechecked = false) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Inverse hyperbolic cosine of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto acosh(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Sine of multivector with specified complexifier
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto sin(const Multivector<Scalar_T, LO, HI, Tune_P>& val, const Multivector<Scalar_T, LO, HI, Tune_P>& i,
           const bool prechecked = false) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Sine of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto sin(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Inverse sine of multivector with specified complexifier
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto asin(const Multivector<Scalar_T, LO, HI, Tune_P>& val, const Multivector<Scalar_T, LO, HI, Tune_P>& i,
            const bool prechecked = false) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Inverse sine of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto asin(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Hyperbolic sine of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto sinh(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Inverse hyperbolic sine of multivector with specified complexifier
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto asinh(const Multivector<Scalar_T, LO, HI, Tune_P>& val, const Multivector<Scalar_T, LO, HI, Tune_P>& i,
             const bool prechecked = false) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Inverse hyperbolic sine of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto asinh(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Tangent of multivector with specified complexifier
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto tan(const Multivector<Scalar_T, LO, HI, Tune_P>& val, const Multivector<Scalar_T, LO, HI, Tune_P>& i,
           const bool prechecked = false) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Tangent of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto tan(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Inverse tangent of multivector with specified complexifier
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto atan(const Multivector<Scalar_T, LO, HI, Tune_P>& val, const Multivector<Scalar_T, LO, HI, Tune_P>& i,
            const bool prechecked = false) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Inverse tangent of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto atan(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Hyperbolic tangent of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto tanh(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Inverse hyperbolic tangent of multivector with specified complexifier
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto atanh(const Multivector<Scalar_T, LO, HI, Tune_P>& val, const Multivector<Scalar_T, LO, HI, Tune_P>& i,
             const bool prechecked = false) -> Multivector<Scalar_T, LO, HI, Tune_P>;

  // Inverse hyperbolic tangent of multivector
  template <template <typename, const index_t, const index_t, typename> class Multivector, typename Scalar_T, const index_t LO,
            const index_t HI, typename Tune_P>
  auto atanh(const Multivector<Scalar_T, LO, HI, Tune_P>& val) -> Multivector<Scalar_T, LO, HI, Tune_P>;
}  // namespace glucat
