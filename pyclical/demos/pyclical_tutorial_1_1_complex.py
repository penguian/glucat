...
def run(ctx):
    ...
    print_line()
    print_fill(
        "Example 9.1. Compute the absolute value r, the square root s, and the cube t of the"
    ...
    print_line()
    print_fill(
        "Example 9.2. Compute log(1+i) and compare the result to the principal logarithm (log(2))/2 + i*pi/4."
    )
    print_line()
